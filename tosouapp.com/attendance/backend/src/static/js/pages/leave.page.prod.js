...
const saveDraft = () => {
  ...
  } catch (e) { console.error('[leave.page.prod.js] Swallowed error:', e); }
};

const clearDraft = () => {
  try { localStorage.removeItem(draftKey()); } catch (e) { console.error('[leave.page.prod.js] Swallowed error:', e); }
};
  ...
  try {
    ...
    if (q) {
      ...
      q.addEventListener('input', () => {
        try { clearTimeout(t); } catch (e) { console.error('[leave.page.prod.js] Swallowed error:', e); }
        t = setTimeout(() => {
...
function initApply() {
  ...
  const d = loadDraft();
  if (d) {
    try { if (d.startDate) $('#startDate').value = d.startDate; } catch (e) { console.error('[leave.page.prod.js] Swallowed error:', e); }
    try { if (d.endDate) $('#endDate').value = d.endDate; } catch (e) { console.error('[leave.page.prod.js] Swallowed error:', e); }
    try { if (d.reason != null) $('#reason').value = d.reason; } catch (e) { console.error('[leave.page.prod.js] Swallowed error:', e); }
  }
  try {
    const g = globalThis;
