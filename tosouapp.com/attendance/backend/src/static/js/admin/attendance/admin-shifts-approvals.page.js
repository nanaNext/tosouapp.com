    ...
    <div class="shift-container">
      <div class="page-header-container" style="padding-right: 8px;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
          ...
          <button id="shiftsExportPdf" type="button" style="display:inline-flex;align-items:center;gap:5px;height:34px;padding:0 12px;border:1px solid #c7d2fe;background:#eef2ff;color:#3730a3;font-size:13px;font-weight:600;cursor:pointer;border-radius:6px;white-space:nowrap;"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg> PDF\u51FA\u529B</button>
        </div>
      </div>
