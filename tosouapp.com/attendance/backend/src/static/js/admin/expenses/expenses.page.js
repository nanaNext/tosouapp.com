      ...
      <section id="expDashRoot" class="exp-dash-root">
        <aside class="exp-dash-side">
          ...
          <div class="exp-dash-side-nav-wrapper">
            ...
            <button type="button" id="expNavHistoryToggle" class="exp-dash-nav-group-toggle" aria-expanded="false">
              <span>\u51E6\u7406\u5B8C\u4E86\u30FB\u5C65\u6B74</span>
            ...
            <div id="expNavHistoryGroup" class="exp-dash-nav-group" hidden>
...
async function initExpSettingsPanel() {
  ...
  document.querySelectorAll('.exp-dash-side .exp-dash-nav[data-nav], .exp-dash-side .exp-dash-nav[data-status]').forEach(btn => {
